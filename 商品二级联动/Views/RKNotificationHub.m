...
//    CGRect frame = view.frame;
    ...
    _countLabel = [[UILabel alloc]initWithFrame:redCircle.frame];
...
//    _countLabel.font = [UIFont boldSystemFontOfSize:12];
    ...
    [view bringSubviewToFront:_countLabel];
    hubView = view;
    [self checkZero];
}
...
- (void)setCircleAtFrame:(CGRect)frame
{
    ...
    baseFrame = frame;
    initialFrame = frame;
    _countLabel.frame = redCircle.frame;
    redCircle.layer.cornerRadius = frame.size.height/2;
//    [_countLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:frame.size.width/2]];
//    [_countLabel setFont:[UIFont boldSystemFontOfSize :frame.size.width*0.6]];
    _countLabel.font = [UIFont boldSystemFontOfSize:frame.size.width*0.65];
...
- (void)setCircleColor:(UIColor*)circleColor labelColor:(UIColor*)labelColor
{
    ...
    [_countLabel setTextColor:labelColor];
}
...
{
    _count = newCount;
    _countLabel.text = [NSString stringWithFormat:@"%@", @(self.count)];
//    _countLabel.font =[UIFont boldSystemFontOfSize:_countLabel.frame.size.width*0.7];
    [self checkZero];
    [self expandToFitLargerDigits];
}

//%% set the font of the label
- (void)set_countLabelFont:(UIFont *)font
{
